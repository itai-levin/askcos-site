...
CELERY_TASK_ROUTES = {
    ...
    'askcos_site.askcos_celery.treebuilder.tb_c_worker.extend_top_precursors': {'queue': 'tb_c_worker'},
    'askcos_site.askcos_celery.treebuilder.tb_c_worker.rerank_results': {'queue': 'tb_c_worker'},
